...
//masukan ke form
$txtKode = isset($_POST['txtKode']) ? $_POST['txtKode'] : $result['id_gejala'];
...
<body>
    ...
    <div class="col-md-12 blue lighten-5">
        <div class="section no-pad-bot container" id="index-banner">
            <div>
                <h3 class="header center">Edit Data Gejala</h3>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8 col-md-offset-2 content">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                  <form name="form1" method="post" action="gejalaEditFungsi.php">
                    <table class="table">
                      <tr>
                        <td>Kode</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td class="right">
                          ...
                          <a class="btn-sm btn-danger raised" href="gejalaTampil.php">Kembali</a>
                        </td>
                      </tr>
                    </table>
                  </form>
