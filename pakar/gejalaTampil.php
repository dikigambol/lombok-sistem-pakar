...
<body>
    ...
    <div class="col-md-12 blue lighten-5">
        <div class="section no-pad-bot container" id="index-banner">
            <div>
                <h3 class="header center">Pengelola Data Gejala</h3>
            </div>
        </div>
    </div>
    <div class="col-md-12 blue lighten-5">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <?php 
                        ...
                        $no = 1;
                        echo "<p>Jumlah gejala saat ini ada $row gejala</p>";
                    ?>
                    <br>
                    <a href="gejalaTambah.php" class="btn-sm btn-success" target="_self">Tambah</a>
                </div>
                <div class="panel-body">
                    <table class="table table-striped" id="table">
                        ...
                        <tr>
                            ...
                            <td><?php echo $result['id_gejala'];?></td>
                            <td><?php echo $result['nama_gejala'];?></td>
                            <td class="right">
                                <a class="btn-xs btn-success raised" href="gejalaEdit.php?kdubah=<?php echo $result['id_gejala']; ?>" target="_self">Edit</a>
                                <a class="btn-xs btn-danger raised" href="gejalaHapus.php?kdhapus=<?php echo $result['id_gejala']; ?>" target="_self" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data..?');">Hapus</a>
                            </td>
                        </tr>
                        <?php
                            }
