...
<body>
    ...
    <div class="col-md-12 blue lighten-5">
        <div class="section no-pad-bot container" id="index-banner">
            <div>
                <h3 class="header center">Pengelola Data Penyakit</h3>
            </div>
        </div>
    </div>
    <div class="col-md-12 blue lighten-5">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <?php 
                        ...
                        $no = 1;
                        echo "<p>Jumlah penyakit saat ini ada $row penyakit</p>";
                    ?>
                    <br>
                    <a href="penyakitTambah.php" class="btn-sm btn-success" target="_self">Tambah</a>
                </div>
                <div class="panel-body">
                    <table class="table table-striped" id="table">
                        ...
                        <?php
                            $sql = "SELECT * from penyakit order by id_Penyakit";
                            $query = mysqli_query($koneksi, $sql);
                            $no = 0;
                        ...
                        <tr>
                            ...
                            <td><?php echo $result['id_penyakit'];?></td>
                            <td><?php echo $result['nama_penyakit'];?></td>
                            <td class="right">
                                <a class="btn-xs btn-success raised" href="penyakitEdit.php?kdubah=<?php echo $result['id_penyakit']; ?>" target="_self">Edit</a>
                                <a class="btn-xs btn-danger raised" href="penyakitHapus.php?kdhapus=<?php echo $result['id_penyakit']; ?>" target="_self" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data..?');">Hapus</a>
                            </td>
                        </tr>
                        <?php
                            }
